...
foreach(_expectedTarget gRPC::gpr gRPC::grpc gRPC::grpc_cronet gRPC::grpc_unsecure gRPC::grpc++ gRPC::grpc++_cronet gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpc++_unsecure gRPC::grpc_plugin_support gRPC::check_epollexclusive gRPC::grpc_create_jwt gRPC::grpc_print_google_default_creds_token gRPC::grpc_verify_jwt gRPC::grpc_cpp_plugin gRPC::grpc_csharp_plugin gRPC::grpc_node_plugin gRPC::grpc_objective_c_plugin gRPC::grpc_php_plugin gRPC::grpc_python_plugin gRPC::grpc_ruby_plugin gRPC::gen_hpack_tables gRPC::gen_legal_metadata_characters gRPC::gen_percent_encoding_tables)
...
# Create imported target gRPC::check_epollexclusive
add_executable(gRPC::check_epollexclusive IMPORTED)

# Create imported target gRPC::grpc_create_jwt
add_executable(gRPC::grpc_create_jwt IMPORTED)

# Create imported target gRPC::grpc_print_google_default_creds_token
add_executable(gRPC::grpc_print_google_default_creds_token IMPORTED)

# Create imported target gRPC::grpc_verify_jwt
add_executable(gRPC::grpc_verify_jwt IMPORTED)
...
# Create imported target gRPC::gen_hpack_tables
add_executable(gRPC::gen_hpack_tables IMPORTED)

# Create imported target gRPC::gen_legal_metadata_characters
add_executable(gRPC::gen_legal_metadata_characters IMPORTED)

# Create imported target gRPC::gen_percent_encoding_tables
add_executable(gRPC::gen_percent_encoding_tables IMPORTED)
